...
var ScrollLock = function (_Component) {
    ...
    function ScrollLock(props) {
        ...
        ['listenToScrollEvents', 'stopListeningToScrollEvents', 'handleEventDelta', 'onWheelHandler', 'onTouchStartHandler', 'onTouchMoveHandler', 'setScrollingElement', 'cancelScrollEvent'].forEach(function (func) {
